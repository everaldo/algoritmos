...
int main(){
  ...
  //Para buscar a ultima ocorrencia, basta fazer uma busca normal
  //e nao sair quando encontrar a primeira ocorrencia
  posicao = n; //sinaliza que o valor não foi encontrado
  for(i = 0; i < n; i++){
    if(v[i] == x){
      posicao = i;
    }
